...
--------------------------------------------------------- */
function HandoverProtocolModal({ job, machine, existing, onClose, onSave, onDelete, canDelete }) {
  ...
  return (
    <Modal title="Protokol o odovzdaní a prevzatí stroja" onClose={onClose} wide>
      ...
      <div className="resp-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
        <SignaturePad label="Podpis nájomcu (zákazník)" value={customerSig} onChange={setCustomerSig} />
        <SignaturePad label="Podpis prenajímateľa (šofér/checker)" value={driverSig} onChange={setDriverSig} />
      </div>
