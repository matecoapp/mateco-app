...
function DispatcherApp() {
  ...
  async function handleProtocolSubmission(data) {
    if (!data.machineId) return; // externý stroj — appka to zámerne ignoruje
    try {
      ...
      if (uploadError) {
        console.error("Upload protokolu zlyhal", uploadError);
        return;
      }
      ...
      console.error("Spracovanie protokolu zlyhalo", e);
    }
  }
