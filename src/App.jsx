...
function resolveCheckerId(depoCheckers, checkerSubstitutions, depo, dateISO) {
  ...
  // a nová opravená), zoberie sa tá NAJNOVŠIE zadaná — appka ich pridáva vždy
...
// Právny text z papierového vzoru — doslovne, nemení sa. Zobrazuje sa aj v appke
...
// Ak zákazka nemá určený dátum konca (bez konca), appka pri vrátení nevie kontrolovať
...
function TransportsOverview({ jobs, drivers, machineById, today, tomorrow, dayAfterTomorrow, user, myEmployee, assignDriver, assignReturnDriver, depoCheckers, checkerSubstitutions, technicianById, technicians, handoverProtocols, onOpenHandoverProtocol, getTransportSendStatus, recordTransportSend, onExpand }) {
  ...
  const transports = useMemo(() => {
    ...
    jobs.forEach((j) => {
      ...
      // Zvoz — pri "Ukončiť zákazku" appka nastaví stav "completed" aj prideleného
      // šoféra naraz, v tom istom kroku. Keby appka zvoz skryla hneď ako je zákazka
...
function ServisStatistiky({ technicians, protocolLogs, start, end, canEdit, showExclusions, setShowExclusions, onUpdateEmployee }) {
  ...
  return (
    <div>
      ...
      <div style={{ background: "var(--warn-bg)", color: "var(--warn)", padding: "10px 14px", borderRadius: 8, fontSize: 12, marginBottom: 20 }}>
        Odpracované hodiny, čas na ceste, prejazdené km a stav servisu (dokončené/čaká na diely...) sa pripravujú —
        vyžaduje si to doplniť tieto údaje aj v číselnej podobe priamo do servisného protokolu.
      </div>
