    ...
    <style>{`
      *, *::before, *::after { box-sizing: border-box; }
      /* iOS "gumové" posúvanie stránky mimo obrazovku (najmä šikmým ťahom prsta) —
         toto je hlavná príčina, prečo sa dá vnorené okno (napr. protokol) vytiahnuť
         mimo viditeľnú plochu. Vypnuté globálne, appka sama vnútri rieši svoje
         vlastné rolovanie tam, kde ho potrebuje (tabuľky, gantt, modálne okná). */
