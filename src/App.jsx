...
function HandoverProtocolModal({ job, machine, existing, user, onClose, onSave, onDelete, canDelete }) {
  const initialPhase = existing?.handoverDone ? "vratenie" : "prevzatie";
  ...
  return (
    <Modal title="Protokol o odovzdaní a prevzatí stroja" onClose={onClose} wide>
      ...
      {isReturnPhase && existing?.handoverDate && (
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
        <button className="btn btn-accent" disabled={!canSave} onClick={handleSave}>
          {isReturnPhase ? "Dokončiť vrátenie" : "Uložiť prevzatie"}
        </button>
        {existing && can(user, "job_edit") && (
          <button className="btn btn-ghost" onClick={() => openPrintableHandoverProtocol(job, machine, existing)}>
            🖨 Tlačová verzia (PDF)
          </button>
        )}
        {existing && job?.customerEmail && can(user, "job_email") && (
          <button
            className="btn btn-ghost"
